...
| Outdoor environment, skybox variants, multi-pass RenderLayers | Phase 5 | Implemented (`zones.rs` multi-camera architecture, `skybox.rs`) | Zone-boundary half-tile splitting landed for dungeon geometry; the door mesh itself and ramp landings remain whole. |
